                            ...
                            <div class="md:grid md:grid-cols-3 md:gap-6">
                                   <div class="md:col-span-1">
                                          <div class="px-4 sm:px-0">
                                                 <h3 class="text-lg font-medium leading-6 text-green-550">Bracelets</h3>
                                                 <p class="mt-1 text-sm text-pink-550">
                                                        Spice up your Bracelets for your clients.
                                                 </p>
                                          </div>
                                   </div>
                                   <div class="mt-4 md:mt-0 md:col-span-2">
                                          <form action="/-/addbracelets" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="px-4 py-2 bg-white space-y-6 sm:p-6">
                                                               ...
                                                               <div class="grid grid-cols-6 gap-4">
                                                                      <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                                                                             <label for="price" class="block text-sm font-medium text-green-550">Bracelet Price</label>
