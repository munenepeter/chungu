                            ...
                            <div class="md:grid md:grid-cols-3 md:gap-6">
                                   <div class="md:col-span-1">
                                          <div class="px-4 sm:px-0">
                                                 <h3 class="text-lg font-medium leading-6 text-green-550">Anklets</h3>
                                                 <p class="mt-1 text-sm text-pink-550">
                                                        Spice up your Anklets for your clients.
                                                 </p>
                                          </div>
                                   </div>
                                   <div class="mt-4 md:mt-0 md:col-span-2">
                                          <form action="/-/addanklets" method="POST" enctype="multipart/form-data">
                                                 <div class="shadow-2xl sm:rounded-md sm:overflow-hidden">
                                                        <div class="px-4 py-2 bg-white space-y-6 sm:p-6">
                                                               <div class="grid grid-cols-3 gap-6">
                                                                      <div class="col-span-3 lg:col-span-2">
                                                                             <label for="name" class="block text-sm font-medium text-green-550">anklet Name</label>
                                                                             <input type="text" name="name" id="name" class="mt-1  py-2 px-4 focus:ring-pink-500 focus:border-pink-500 block w-full shadow-md sm:text-sm border-green-550 rounded-md placeholder-green-500 text-pink-550" placeholder="What is your anklet name?">
                                                                      </div>
                                                               ...
                                                               <div class="grid grid-cols-6 gap-4">
                                                                      <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                                                                             <label for="price" class="block text-sm font-medium text-green-550">Anklet Price</label>
