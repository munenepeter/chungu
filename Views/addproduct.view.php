                            ...
                            <div class="md:grid md:grid-cols-3 md:gap-6">
                                   <div class="md:col-span-1">
                                          <div class="px-4 sm:px-0">
                                                 <h3 class="text-lg font-medium leading-6 text-green-550">Necklaces</h3>
                                                 <p class="mt-1 text-sm text-pink-550">
                                                        Spice up your Necklaces for your clients.
                                                 </p>
                                          </div>
                                   </div>
                                   <div class="mt-4 md:mt-0 md:col-span-2">
                                          <form action="/-/addnecklaces" method="POST" enctype="multipart/form-data">
