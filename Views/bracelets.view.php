...
<?php if (isset($_GET['pro_id'])) : ?>
    <div class="grid place-items-center">
        ...
        <a class="py-4" href="/shop/bracelets">
            <h5 style="font-family: 'Cedarville Cursive', cursive;" class="mb-8 text-3xl font-black tracking-loose text-pink-550 dark:text-white">Related bracelets</h5>
        </a>
        ...
        <?php for ($i = 0; $i < 3; $i++) : ?>
            <div class="mx-auto">
                <div class="max-w-sm bg-white rounded-lg">
                    <a class="" href="/shop/bracelets?pro_id=8hcjd9">
                        <img class="object-cover transform transition duration-500 hover:scale-125  w-48 h-32 rounded-lg " src="../static/imgs/bracelets/fancy-beads.jpg" alt="">
                    </a>
                    <div class="mt-8">
                        <p style="font-family: 'Cedarville Cursive', cursive;" class="text-xl mb-2 font-extrabold text-gray-700 dark:text-gray-400">Timeless darlings.</p>
                        <p class="mb-4 font-semibold text-gray-700 dark:text-gray-400">Ksh 200.00</p>
