    ...
    <div class="grid place-items-center">
        <div class="">
            <div class="max-w-sm bg-white rounded-lg">
                <a class="" href="/shop/bracelets?pro_id=8hcjd9">
                ...
                <div class="mt-8">
                    ...
                    <p class="mb-4 font-semibold text-gray-700 dark:text-gray-400">Beautiful bracelets for every occassion</p>
        ...
        <?php for ($i = 0; $i < 4; $i++) : ?>
            <div class="mx-auto p-4">
                <div class="max-w-sm bg-white rounded-lg">
                    <a class="" href="/shop/bracelets?pro_id=8hcjd9">
                        <img class="object-cover transform transition duration-500 hover:scale-125  w-48 h-64 rounded-lg " src="../static/imgs/bracelets/fancy-beads.jpg" alt="">
                    </a>
                    <div class="mt-8">
...
<?php else : ?>
    ...
    <aside class="hidden md:block h-screen sticky top-4 -z-50 w-1/4 mt-16 p-6 sm:w-60 text-green-550">
        <nav class="space-y-8 text-sm">
            ...
            <div class="space-y-2">
                <div class="flex flex-col space-y-2">
                    ...
                    <a class=" hover:text-pink-550" rel="noopener noreferrer" href="#">bracelets
                    </a>
                    <a class=" hover:text-pink-550" rel="noopener noreferrer" href="#">Single bracelets
                    </a>
        ...
        <section id="bracelets" class="md:h-screen md:overflow-y-auto w-full md:overflow-x-hidden">
                ...
                <?php for ($i = 0; $i < 12; $i++) : ?>
                    <div class="p-4 w-full">
                        <a class="block relative h-56 rounded overflow-hidden">
                            <img alt="Chungu Image" class="transform transition duration-500 hover:scale-125 object-cover  w-full h-full block" src="../static/imgs/bracelets/02.jpeg">
                        </a>
                        <div class="mt-4">
                            <h3 class="text-pink-550 text-xs tracking-widest title-font mb-1 uppercase">Bracelets</h3>
