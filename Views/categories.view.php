                                    ...
                                    <div class="md:text-base text-gray-800 flex items-center gap-2">
                                        ...
                                        <?php if (isAdmin()) : ?>
                                            <div x-data="{ open: false }">
                                                ...
                                                <a @click.prevent="open = ! open" href="deleteuser?user_id<?= "$category->category" ?>">
                                                        ...
                                                        <div class="border bg-white p-4 my-2 max-w-md rounded-lg">
                                                            <div class="sm:flex sm:items-start">
                                                                ...
                                                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Delete <?= ucfirst($category->name); ?></h3>
                                                                    <div class="mt-2">
                                                                        <p class="text-sm text-gray-500">Are you sure you want to delete this category (<span class="font-medium "><?= ucfirst($category->name); ?></span>)? All of <span class="font-medium "><?= ucfirst("$category->name's"); ?></span> data will be permanently removed. This action cannot be undone!</p>
                                                                    </div>
                                                                </div>
