<div class="col-span-2 mx-auto">
    <div class="max-w-sm bg-white rounded-lg">
        <a class="" href="#">
            <img class="w-32 h-32 rounded-lg" src="https://flowbite.com/docs/images/blog/image-1.jpg" alt="">
        </a>
        <div class="mt-8">
            ...
            <p class="mb-8 font-semibold text-gray-700 dark:text-gray-400">Beautiful earrings for every occassion</p>
            <h5 class="mb-4 text-xl font-semibold tracking-tight text-pink-550 dark:text-white">Available colors</h5>
        </div>
        <div class="items-center flex justify-start space-x-2">
