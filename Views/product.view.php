    ...
    <div class="container px-5 py-8 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <h2 class="text-sm title-font text-green-550 tracking-widest"><?= $product->category_id; ?></h2>
                ...
                <p class="leading-relaxed">Beautiful <?= plural($product->category_id, 2); ?> for every occassion</p>
