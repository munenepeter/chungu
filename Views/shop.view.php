                ...
                <?php for ($i = 0; $i < 3; $i++) : ?>
                    <div class=" p-4 w-full">
                        <a class="block relative h-48 rounded overflow-hidden">
                            <img alt="Chungu Image" class="transform transition duration-500 hover:scale-125 object-cover object-center w-full h-full block" src="../static/imgs/earrings/fancy-beads.jpg">
                        </a>
                        <div class="mt-4">
