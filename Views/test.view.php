                                        ...
                                        <td class="px-4 py-4 whitespace-no-wrap border-b border-green-200 text-sm leading-5 font-medium">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <!-- Main modal -->
                                                    <div id="readModal<?= $product->id ?>" data-modal-placement="center" tabindex="-1"  aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                                                ...
                                                <div>
                                                    ...
                                                    <!-- Main modal -->
                                                    <div id="updateModal<?= $product->id ?>" data-modal-placement="center" tabindex="-1"  aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                                                ...
                                                <?php if (isAdmin()) : ?>
                                                    <div>
                                                        ...
                                                        <!-- Main modal -->
                                                        <div id="deleteModal<?= $product->id ?>" data-modal-placement="center" tabindex="-1"   aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
