                                    ...
                                    <td class="text-sm p-3 whitespace-no-wrap text-sm group-hover:visible">
                                        <div class="md:text-base text-gray-800 flex items-center gap-2">
                                            <div x-data="{ open: false }">
                                                <a @click.prevent="open = true" href="viewuser?id<?= "$user->id&uname=$user->username" ?>">
                                            ...
                                            <div x-data="{ open: false }">
                                                <a @click.prevent="open = true" href="edituser?id<?= $user->username; ?>">
                                            ...
                                            <?php if (isAdmin()) : ?>
                                                <div x-data="{ open: false }">
                                                    <a @click.prevent="open = true" href="deleteuser?id<?= "$user->username" ?>">
