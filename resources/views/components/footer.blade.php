<footer id="footer" class="border-t bg-gray-50 left-50 w-full">
        ...
        <div class="md:flex md:justify-between">
            ...
            <article class="grid md:grid-cols-3 grid-cols-2 p-2">
                <ul class="space-y-2">
                    ...
                    <li> <a class="my-3 text-asparagus-500 hover:underline" href="{{route('collections')}}">Collections<span
    ...
    <div class="mt-2">
        <div class="flex px-3 m-auto border-t text-gray-800 text-sm flex-col max-w-screen-lg items-center">
            ...
            <div class="text-center text-japonica-800 md:text-sm text-xs">&copy; 2020 - {{ date('Y') }}, All rights reserved | Chungu Collections
            </div>
        </div>
    </div>
</footer>