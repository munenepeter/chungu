            ...
            <div class="md:flex md:justify-between">
                <div class="hidden md:block p-2">
                    <p style="font-family: 'Courgette', cursive;"
                        class="text-green-550 ml-2 hover:text-orange-550 text-xl font-black ">Chungu</p>
                ...
                <article class="grid md:grid-cols-3 sm:grid-cols-2 p-2">
                    <ul class="space-y-2">
                        ...
                        <li> <a class="my-3 text-green-550 hover:underline" href="/shop">Shop <span
                                    class="text-teal-600 text-xs p-1"></span></a>
                        </li>
                        <li> <a class="my-3 text-green-550 hover:underline" href="/cart">Cart<span
                                    class="text-teal-600 text-xs p-1"></span></a>
                        </li>
                        @if (Route::has('login'))
                            <li>
                                ...
                                @auth
                                    <a href="{{ url('/dashboard') }}"
                                        class="my-3 text-green-550 hover:underline py-2 hover:text-orange-550">Dashboard</a>
                                @else
                                    <a href="{{ route('login') }}"
                                        class="my-3 text-green-550 hover:underline py-2 hover:text-orange-550">Log in</a>
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}"
                                            class="my-3 text-green-550 hover:underline py-2 pl-3 hover:text-orange-550">Register</a>
                                    @endif @endauth
                                </li>
                            @endif
                        ...
                        <ul class="space-y-2">
                            ...
                            <li> <a class="text-green-550 hover:underline" href="/help-center">Help Center <span
                                        class="text-teal-600 text-xs p-1"></span></a>
                            </li>
                            <li> <a class="text-green-550 hover:underline" href="/privacy-policy">Privacy Policy <span
                                        class="text-teal-600 text-xs p-1"></span></a>
                            </li>
                            <li> <a class="text-green-550 hover:underline" href="/faqs">FAQs<span
                                        class="text-teal-600 text-xs p-1"></span></a>
                            </li>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li> <a class="text-green-550 hover:underline" href="/#">+2547 426 41376<span
                                        class="text-teal-600 text-xs p-1"></span></a>
                            </li>
                            <li> <a class="text-green-550 hover:underline" href="/#">+2547 980 55244 <span
                                        class="text-teal-600 text-xs p-1"></span></a>
                            </li>
                ...
                <div class="flex px-3 m-auto border-t text-gray-800 text-sm flex-col max-w-screen-lg items-center">
                    <div class="md:flex-auto md:flex-row-reverse my-2 flex-row flex"> <a target="_blank"
                            ...
                            title="Pinterest"> <svg xmlns="http://www.w3.org/2000/svg"
                                class="w-6 h-6 text-green-550 hover:text-orange-550" fill="currentColor" viewBox="0 0 32 32"
                                class="w-4 h-4">
                                <path
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="currentColor"
                                class="w-6 h-6 text-green-550 hover:text-orange-550">
                                <path
                            ...
                            </svg> </a> <a target="_blank" href="https://www.facebook.com/chungucollections/"
                            class="w-6 mx-1"> <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 32 32" class="w-6 h-6 text-green-550 hover:text-orange-550">
                                <path
                    ...
                    <div class="text-center">&copy; 2020 - {{ date('Y') }}, All rights reserved | Chungu Collections
                    </div>
                </div>
            </div>
        </footer>
