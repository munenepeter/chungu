...
<head>
    ...
    <title>Chungu {{ empty(request()->segments()) ? 'Blog' : ucwords('| ' . request()->segment(1)) }}</title>
    <link rel="icon" href="{{ asset('favicon.svg') }}">

    {{-- SEO --}}

    <meta name="title" content="Chungu Blog — Informative, engaging and lovely stories & poems">
    ...
    <meta property="og:title" content="Chungu — Informative, engaging and lovely stories & poems">
    ...
    <meta property="twitter:title" content="Chungu — Informative, engaging and lovely stories & poems">
