    ...
    <footer id="footer" class="border-t bg-gray-50 left-50 w-full bottom-0">
        ...
        <div class="mt-2">
            <div class="flex px-3 m-auto border-t text-gray-800 text-sm flex-col max-w-screen-lg items-center">
                <div class="md:flex-auto md:flex-row-reverse my-2 flex-row flex"> <a target="_blank" rel="noopener noreferrer" href="https://www.pinterest.com/chungucollections/" class="w-6 mx-1" title="Pinterest"> <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-green-550 hover:text-orange-550" fill="currentColor" viewBox="0 0 32 32" class="w-4 h-4">
                        ...
                        </svg> </a> <a target="_blank" href="https://tiktok.com/chungucollections" class="w-6 mx-1"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="currentColor" class="w-6 h-6 text-green-550 hover:text-orange-550">
                        ...
                        </svg> </a> <a target="_blank" href="https://twitter.com/chungucoll" class="w-6 mx-1"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" class="w-6 h-6 text-green-550 hover:text-orange-550">
                        ...
                        </svg> </a> <a target="_blank" href="https://www.facebook.com/chungucollections/" class="w-6 mx-1"> <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-6 h-6 text-green-550 hover:text-orange-550">
                            <path d="M32 16c0-8.839-7.167-16-16-16-8.839 0-16 7.161-16 16 0 7.984 5.849 14.604 13.5 15.803v-11.177h-4.063v-4.625h4.063v-3.527c0-4.009 2.385-6.223 6.041-6.223 1.751 0 3.584 0.312 3.584 0.312v3.937h-2.021c-1.984 0-2.604 1.235-2.604 2.5v3h4.437l-0.713 4.625h-3.724v11.177c7.645-1.199 13.5-7.819 13.5-15.803z"></path>
                        </svg> </a> <a href="https://www.instagram.com/chungucollections/" class="w-6 mx-1"> <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-6 h-6 text-green-550 hover:text-orange-550">
                ...
                <div class="text-center">&copy; 2020 - {{date('Y')}}, All rights reserved | Chungu Collections</div>
            </div>
        </div>
    </footer>
</x-template-layout>