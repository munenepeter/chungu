...
<head>
    ...
    <title>{{ config('app.name', 'Chungu Collections') }}</title>
...
<body>
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 pr-4">
        <div class="flex flex-wrap justify-between items-center mx-auto  p-1">
            <a href="/" class="p-2 block hover:text-orange-550">
                <p style="font-family: 'Cedarville Cursive', cursive;" class="ml-2 hover:text-orange-550 text-4xl font-black dark:text-white">Chungu</p>
                <p class="text-lg font-bold whitespace-nowrap dark:text-white hover:text-orange-550">COLLECTIONS</p>
            </a>
            ...
            <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
                <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium items-center">
                    <li>
                        <a href="/#about" class="text-md block py-2 pr-4 pl-3 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 hover:text-orange-550 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">About</a>
                    </li>
                    <li>
    ...
    <footer id="footer" class="border-t bg-gray-50 left-50 w-full fixed bottom-0">
        <div class=" pt-5">
            <div class="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
                <div class="p-5">
                    <p style="font-family: 'Cedarville Cursive', cursive;" class="text-green-550 ml-2 hover:text-orange-550 text-4xl font-black dark:text-white">Chungu</p>
                    <p class="text-green-550 text-lg font-bold whitespace-nowrap dark:text-white hover:text-orange-550">COLLECTIONS</p>
                </div>
                ...
                <div class="p-5">
                    <div class="text-sm uppercase text-orange-550 font-bold">Contact us</div>
      ...
      max-w-screen-lg items-center">
                <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
                    <a target="_blank" rel="noopener noreferrer" href="https://www.pinterest.com/chungucollections/" class="w-6 mx-1" title="Pinterest">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-green-550 hover:text-orange-550" fill="currentColor" viewBox="0 0 32 32" class="w-4 h-4">
                    ...
                    <a target="_blank" href="https://tiktok.com/chungucollections" class="w-6 mx-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="currentColor" class="w-6 h-6 text-green-550 hover:text-orange-550">
                    ...
                    <a target="_blank" href="https://twitter.com/chungucoll" class="w-6 mx-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" class="w-6 h-6 text-green-550 hover:text-orange-550">
                    ...
                    <a target="_blank" href="https://www.facebook.com/chungucollections/" class="w-6 mx-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-6 h-6 text-green-550 hover:text-orange-550">
