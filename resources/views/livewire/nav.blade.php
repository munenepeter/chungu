        ...
        <div class="flex justify-between py-4 items-center">
            ...
            <form class="max-w-lg md:w-full relative">
                <input name="search" type="search" placeholder="Search..."
                    class="w-1/2 pl-10 text-sm border-b border-asparagus-400 rounded-lg text-japonica-500 placeholder:text-asparagus-500 focus:outline-none focus:border-japonica-500 focus:ring-1 focus:ring-orange-500"
                    value="" />
                <button
