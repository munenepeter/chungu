        ...
        <div class="flex justify-between py-4 items-center">
            ...
            <form class="max-w-lg md:w-full relative">
                <input name="search" type="search" placeholder="Search..."
                    class="w-1/2 pl-10 text-sm border-asparagus-400 border-b rounded-lg text-japonica-500 placeholder:text-asparagus-500 focus:outline-none focus:border-japonica-500 focus:ring-1 focus:ring-orange-500"
                    value="" />
                <button
            ...
            <button class="text-sm text-asparagus-500 hover:text-japonica-500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="md:w-6 md:h-6 w-8 h-8">
