                         ...
                         <div class="flex items-center gap-2">
                             ...
                             <div>
                                 <svg xmlns="http://www.w3.org/2000/svg"
                                     class="hover:text-blue-600 text-blue-400 w-5 h-5" fill="none"
                                     viewBox="0 0 24 24" stroke="currentColor">
                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                         d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                         d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.470-8.268-2.943-9.542-7z" />
                                 </svg>
                                                         ...
                                                         <div class="grid grid-cols-3 gap-2 sm:col-span-2">
                                                             <div>
                                                                 <label for="quantity"
                                                                     class="block mb-2 text-sm font-medium text-green-550 dark:text-white">Product
                                                                     Quantity</label>
                                                                 <input type="number" name="quantity" value="65"
                                                                     id="quantity"
                             ...
                             <div>
                                 <!-- Modal toggle -->
                                 <svg xmlns="http://www.w3.org/2000/svg"
                                     class="cursor-pointer hover:text-red-600 text-red-400 h-5 w-5" fill="none"
                                     viewBox="0 0 24 24" stroke="currentColor">
                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                         d="M19 7l-.8612.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                 </svg>
                                 <!-- Main modal -->
                                 <template x-if="7">
                                     <div style="background-color: rgba(0, 0, 0, .5)"
