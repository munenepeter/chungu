<x-jet-dialog-modal wire:model="addSource">
    <x-slot name="title">
        <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
            ...
            <button wire:click="$toggle('addSource')" type="button" class="text-orange-500 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="defaultModal">
        ...
        <form>
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <x-jet-input id="location" wire:model="location" placeholder="Where is the source located?" class="block mt-1 w-full" type="text" name="location" :value="old('location')" required autofocus />
                </div>
