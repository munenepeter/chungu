    ...
    <div class="relative" x-data="{ activeSlide: 1, slides: [1, 2, 3, 4, 5] }">
        ...
        <div class="absolute inset-0 flex -mt-24">
            <div class="flex items-center justify-start w-1/2">
                <button class="bg-teal-100 text-orange-550 hover:text-orange-500 font-bold hover:shadow-lg rounded-full w-12 h-12 -ml-6" x-on:click="activeSlide = activeSlide === 1 ? slides.length : activeSlide - 1">
                    &#8592;
                </button>
            </div>
            <div class="flex items-center justify-end w-1/2">
                <button class="bg-teal-100 text-orange-550 hover:text-orange-500 font-bold hover:shadow rounded-full w-12 h-12 -mr-6" x-on:click="activeSlide = activeSlide === slides.length ? 1 : activeSlide + 1">
                    &#8594;
                </button>
            </div>
        </div>
