...
<div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 dark:text-gray-100 leading-7 font-semibold"><a href="https://laravel.com/docs">Most Viewed Categories</a></div>
        </div>
    ...
    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 dark:text-gray-100 leading-7 font-semibold"><a href="https://laracasts.com">Most Viewed Products</a></div>
        </div>
